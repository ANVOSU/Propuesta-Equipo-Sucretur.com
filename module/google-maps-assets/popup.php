<link rel="stylesheet" href="./controller/extension/module/google-maps-assets/popup.css">

<div class="eapps-deactivation-popup-overlay"></div>

<div class="eapps-deactivation-popup">
    <form method="post" id="google-maps-deactivateForm" action="">
        <div class="eapps-deactivation-popup-header">
            <div class="eapps-deactivation-popup-header-heading">You have succesfully uninstalled Elfsight Google Maps</div>
...
<script>
    ...
    node.async = true;
    node.src = './controller/extension/module/google-maps-assets/popup.js';
